        ...
        <div className='w-full lg:w-5/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max'>
          ...
          {activeStep === 3 && paymentMethod && (
            <button
              ...
              className='w-full bg-green-600 hover:bg-green-700 transition-all duration-300 text-white p-3 rounded-lg cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50'
            >
